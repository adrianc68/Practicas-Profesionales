...
import org.gui.users.coordinator.card.ProjectCard;
...
public class ProjectController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        setProjectToScrollPaneFromDatabase();
    }
    ...
    void addButtonPressed(ActionEvent event) {
        ...
        if( registerProjectController.getStatusAddOperation() ) {
    ...
    void removeButtonPressed(ActionEvent event) {
        if(selectedProjectCard != null){
            ...
            if( removeProjectController.getStatusRemoveOperation() ) {
    ...
    private void setProjectToScrollPaneFromDatabase() {
