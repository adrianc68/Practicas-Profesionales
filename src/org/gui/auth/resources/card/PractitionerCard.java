...
public class PractitionerCard extends VBox{
    ...
    private void initCard() {
        ...
        professorAssignedLabel.getStyleClass().add("cardLabel");
        professorAssignedLabel.setText(nameProfessor);
        professorAssignedLabel.setFont( Font.font(FONT_SIZE) );
        professorAssignedLabel.setMinHeight(USE_PREF_SIZE);
    ...
    public void addAssignButton() {
        // T-O Ternary Operator here!
        button = ( button == null ) ? new Button("Asignar") : button;
        button.setPrefHeight(BUTTON_HEIGHT);
        button.setMinHeight(BUTTON_HEIGHT);
        button.getStyleClass().add("withBorderButton");
