    ...
    private List<Project> getProjectsByStatementAndIDPractitioner(String statement, int idPractitioner){
        ...
        try(Connection conn = database.getConnection() ) {
            ...
            while( resultSet.next() ) {
                ...
                company.setId(resultSet.getInt("COMP.id_company"));
                company.setName(resultSet.getString("COMP.name"));
                company.setAddress(resultSet.getString("COMP.address"));
                company.setEmail(resultSet.getString("COMP.email"));
                company.setState(resultSet.getString("COMP.state"));
                company.setPhoneNumber(resultSet.getString("COMP.phoneNumber"));
                company.setDirectUsers(resultSet.getInt("COMP.direct_users"));
                company.setIndirectUsers(resultSet.getInt("COMP.indirect_users"));
                company.setSector(Sector.valueOf(resultSet.getString("COMP.sector").toUpperCase()));
                company.setCity(resultSet.getString("COMP.city"));
